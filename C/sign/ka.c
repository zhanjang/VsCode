...
float note_to_frequency(int note, int octave) 
{
    switch(note) 
    {
        case 1: return (octave == 4) ? D4 : D5;
        case 2: return (octave == 4) ? E4 : E5;
        case 3: return (octave == 4) ? F4 : F5;
        case 4: return (octave == 4) ? G4 : G5;
        case 5: return (octave == 4) ? A4 : A5;
        case 6: return (octave == 4) ? B4 : B5;
        case 7: return (octave == 4) ? C5 : C6;
        default: return 0;
    }
}
...
{
    float beat_duration = 60.0f / 72.0f;
    float duration;
...
{
    {3,5,get_duration_44(2,0),0.7},{2,5,get_duration_44(2,0),0.7},
    {1,5,get_duration_44(2,0),0.7},{7,4,get_duration_44(2,0),0.7},
    {6,4,get_duration_44(2,0),0.7},{5,4,get_duration_44(2,0),0.7},
    {6,4,get_duration_44(2,0),0.7},{7,4,get_duration_44(2,0),0.7},
    {1,5,get_duration_44(2,0),0.7},{7,4,get_duration_44(2,0),0.7},
    {6,4,get_duration_44(2,0),0.7},{5,4,get_duration_44(2,0),0.7},
    {4,4,get_duration_44(2,0),0.7},{3,4,get_duration_44(2,0),0.7},
    {4,4,get_duration_44(2,0),0.7},{2,4,get_duration_44(2,0),0.7},
};   
